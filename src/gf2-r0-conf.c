/* GF2 Rev. 0 Configuration Program - Version 1.0 for Debian Linux
...
int main(int argc, char **argv)
{
    ...
    {
        fprintf(stderr, "Error: Missing argument.\nUsage: gf2-r0-conf SERIALNUMBER\n");
    ...
    {
        devhandle = libusb_open_device_with_vid_pid_serial(context, 0x10C4, 0x87A0, (unsigned char *)argv[1]);  // Open the device having the specified serial number, and get the device handle
...
void write_pin_cfg(libusb_device_handle *devhandle)  // Writes the pin configuration values into the OTP ROM
{
    unsigned char control_buf_out[20] = {
        ...
        0x02,        // GPIO.4 as output
        0x02,        // GPIO.5 as output
        0x02,        // GPIO.6 as output
...
{
    unsigned char control_buf_out[64] = {
        0x30, 0x03, 0x47, 0x00, 0x46, 0x00, 0x32, 0x00,  // GF2 Function Generator
...
{
    unsigned char control_buf_out[64] = {
        0x1C, 0x03, 0x47, 0x00, 0x46, 0x00, 0x32, 0x00,  // GF2-00xxxxxx
...
void write_usb_cfg(libusb_device_handle *devhandle)  // Writes the USB configuration values into the OTP ROM
{
    unsigned char control_buf_out[10] = {
        ...
        0xF1, 0x8B,  // PID is 0x8BF1
        0x7E,        // Maximum power is 252mA (0x7E)
